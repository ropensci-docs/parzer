...
- [`sp::char2dms`](https://edzer.github.io/sp/reference/char2dms.html):
  is most similar to
  [`parzer::parse_lat`](https://docs.ropensci.org/parzer/reference/parse_lat.md)
  and
  [`parzer::parse_lon`](https://docs.ropensci.org/parzer/reference/parse_lon.md).
  However, with
  [`sp::char2dms`](https://edzer.github.io/sp/reference/char2dms.html)
